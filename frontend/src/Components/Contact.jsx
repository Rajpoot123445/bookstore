...
const Contact = () => {
    return (
        <div>
            <div class="font-[sans-serif] max-w-6xl mt-16 mx-auto p-4">
                <div class="bg-white dark:bg-slate-600 p-8">
                    ...
                    <form class="space-y-3 max-w-xl mx-auto text-gray-800">
                        <input type='text' placeholder='Name'
                            class="w-full border rounded py-3 px-4 text-sm focus:outline-blue-600" />
                        <input type='email' placeholder='Email'
                            class="w-full border rounded py-3 px-4 text-sm focus:outline-blue-600" />
                        <input type='email' placeholder='Phone No.'
                            class="w-full border rounded py-3 px-4 text-sm focus:outline-blue-600" />
                        <textarea placeholder='Message' rows="6"
                            class="w-full border rounded px-4 text-sm pt-3 focus:outline-blue-600"></textarea>
                        <button type='button'
                            class="text-white w-full bg-blue-600 hover:bg-blue-700 rounded text-sm px-6 py-3 !mt-6">
                    ...
                    <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-12 mt-12">
                        ...
                        <div class="flex flex-col items-center bg-white">
                            ...
                            <div class="mt-4 text-center">
                                ...
                                <p class="text-sm text-gray-500 mt-2">+1-548-2588</p>
                            </div>
                        </div>
