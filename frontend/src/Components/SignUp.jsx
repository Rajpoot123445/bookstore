...
const SignUp = () => {
    return (
        <div>
            <div class="font-[sans-serif] bg-white dark:bg-slate-600 max-w-6xl flex items-center mx-auto md:h-screen p-4">
                <div class="grid md:grid-cols-3 items-center shadow-[0_2px_20px_1px_rgba(16,81,250,1)] rounded-xl overflow-hidden">
                    ...
                    <form class="md:col-span-2 w-full py-6 px-6 sm:px-16">
                        ...
                        <p class="text-gray-800 text-sm mt-6 text-center">Already have an account? <Link to="/" class="text-blue-600 font-semibold hover:underline ml-1">Login here</Link></p>
                    </form>
                </div>
            </div>
        </div>
